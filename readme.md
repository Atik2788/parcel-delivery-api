...
- **PATCH /api/v1/users/:id**: Update user profile (requires authentication).

### Parcel Routes
- **POST /api/v1/parcels**: Create a new parcel (SENDER only).
- **PATCH /api/v1/parcels/claim/:id**: Claim a parcel (RECEIVER only).
- **PATCH /api/v1/parcels/update-tracking-sender**: Update parcel status (SENDER only).
- **PATCH /api/v1/parcels/update-tracking-receiver**: Update parcel status (RECEIVER only).
- **PATCH /api/v1/parcels/rating/:trackingId**: Rate a parcel (SENDER or RECEIVER).
- **PATCH /api/v1/parcels/cancel/:parcelId**: Cancel a parcel (SENDER only).
- **GET /api/v1/parcels/my-parcels-sender**: Get sender's parcels (SENDER only).
- **GET /api/v1/parcels/my-parcels-receiver**: Get receiver's parcels (RECEIVER only).
- **GET /api/v1/parcels/incoming-parcels**: Get unclaimed parcels (RECEIVER only).

### Admin Routes
- **GET /api/v1/adminRoute/all-users**: Fetch all users (ADMIN or SUPER_ADMIN).
- **GET /api/v1/adminRoute/all-parcels**: Fetch all parcels (ADMIN or SUPER_ADMIN).
- **PATCH /api/v1/adminRoute/parcel-block/:id**: Block/unblock a parcel (ADMIN or SUPER_ADMIN).
...
#### 2. Claim a Parcel
- **Endpoint**: `PATCH /api/v1/parcels/claim/:id`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
- **Endpoint**: `PATCH /api/v1/parcels/update-tracking-receiver`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
- **Endpoint**: `PATCH /api/v1/parcels/update-tracking-sender`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
#### 5. Rate a Parcel
- **Endpoint**: `PATCH /api/v1/parcels/rating/:trackingId`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
#### 6. Cancel a Parcel
- **Endpoint**: `PATCH /api/v1/parcels/cancel/:parcelId`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
- **Endpoint**: `GET /api/v1/parcels/my-parcels-sender`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
- **Endpoint**: `GET /api/v1/parcels/my-parcels-receiver`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
- **Endpoint**: `GET /api/v1/parcels/incoming`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
### Admin API Testing
#### 1. Get All Users
- **Endpoint**: `GET /api/v1/adminRoute/all-users?search=john&page=1&limit=10`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
#### 2. Get All Parcels
- **Endpoint**: `GET /api/v1/adminRoute/all-parcels?search=TRK&page=1&limit=10`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
...
- **Endpoint**: `PATCH /api/v1/adminRoute/parcel-block/:id`
- **Headers**:
  ```http
  Authorization: Bearer <jwt-access-token>
  ```
